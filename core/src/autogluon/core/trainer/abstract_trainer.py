...
class AbstractTrainer:
    ...
    def train_multi_levels(self, X, y, hyperparameters: dict, X_val=None, y_val=None, X_unlabeled=None, base_model_names: List[str] = None,
                           ...
                           relative_stack=True, level_time_modifier=0.333, infer_limit=None, infer_limit_batch_size=None, pretrain_kwargs=None) -> List[str]:
        """
    ...
    def stack_new_level(self, X, y, models: Union[List[AbstractModel], dict], X_val=None, y_val=None, X_unlabeled=None, level=1, base_model_names: List[str] = None,
                        core_kwargs: dict = None, aux_kwargs: dict = None, name_suffix: str = None, infer_limit=None, infer_limit_batch_size=None, pretrain_kwargs=None) -> (List[str], List[str]):
        """
        ...
        core_models = self.stack_new_level_core(X=X, y=y, X_val=X_val, y_val=y_val, X_unlabeled=X_unlabeled, models=models,
                                                level=level, infer_limit=infer_limit, infer_limit_batch_size=infer_limit_batch_size, base_model_names=base_model_names, pretrain_kwargs=pretrain_kwargs, **core_kwargs)
    ...
    def stack_new_level_core(self, X, y, models: Union[List[AbstractModel], dict], X_val=None, y_val=None, X_unlabeled=None,
                             ...
                             infer_limit=None, infer_limit_batch_size=None, pretrain_kwargs=None, **kwargs) -> List[str]:
        """
        ...
        return self._train_multi(X=X_init, y=y, X_val=X_val, y_val=y_val, X_unlabeled=X_unlabeled,
                                 models=models, level=level, stack_name=stack_name, compute_score=compute_score, fit_kwargs=fit_kwargs, pretrain_kwargs=pretrain_kwargs, **kwargs)
    ...
    def _train_single(self, X, y, model: AbstractModel, X_val=None, y_val=None, pretrain_kwargs=None, **model_fit_kwargs) -> AbstractModel:
        """
    ...
    def _train_and_save(self, X, y, model: AbstractModel, X_val=None, y_val=None, stack_name='core', level=1, compute_score=True, pretrain_kwargs=None, **model_fit_kwargs) -> List[str]:
        """
        ...
        try:
            ...
            if not isinstance(model, BaggedEnsembleModel) and X_pseudo is not None and y_pseudo is not None and X_pseudo.columns.equals(X.columns):
                ...
                model = self._train_single(X, y, model, X_val, y_val, pretrain_kwargs=pretrain_kwargs, **model_fit_kwargs)
    ...
    def _train_multi_initial(self, X, y, models: List[AbstractModel], k_fold, n_repeats, hyperparameter_tune_kwargs=None, time_limit=None, feature_prune_kwargs=None, pretrain_kwargs=None, **kwargs):
        """
        ...
        if not bagged:
            ...
            models = self._train_multi_fold(models=models, hyperparameter_tune_kwargs=hyperparameter_tune_kwargs,
                                            time_limit=time_limit, time_split=time_split, time_ratio=time_ratio, pretrain_kwargs=pretrain_kwargs, **fit_args)
        else:
            time_ratio = hpo_time_ratio if hpo_enabled else 1
    ...
    def _train_multi_fold(self, X, y, models: List[AbstractModel], time_limit=None, time_split=False, time_ratio=1, hyperparameter_tune_kwargs=None, pretrain_kwargs=None, **kwargs) -> List[str]:
        """
        ...
        for i, model in enumerate(models):
            ...
            if time_split:
                ...
                if time_limit is None:
                    ...
                    time_start_model = time.time()
                    time_left = time_limit - (time_start_model - time_start)
            model_name_trained_lst = self._train_single_full(X, y, model, time_limit=time_left, hyperparameter_tune_kwargs=hyperparameter_tune_kwargs_model, pretrain_kwargs=pretrain_kwargs, **kwargs)
    ...
    def _train_multi(self, X, y, models: List[AbstractModel], hyperparameter_tune_kwargs=None, feature_prune_kwargs=None, k_fold=None, n_repeats=None, n_repeat_start=0, time_limit=None, pretrain_kwargs=None, **kwargs) -> List[str]:
        """
        ...
        if n_repeat_start == 0:
            ...
            model_names_trained = self._train_multi_initial(X=X, y=y, models=models, k_fold=k_fold, n_repeats=n_repeats_initial, hyperparameter_tune_kwargs=hyperparameter_tune_kwargs,
                                                            feature_prune_kwargs=feature_prune_kwargs, time_limit=time_limit, pretrain_kwargs=pretrain_kwargs, **kwargs)
